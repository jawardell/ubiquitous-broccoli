...
and the upper bound is a line with a variable slope, a model that we call a skewed-top corridor. Although the data changes because of the upper bound's slope, intriguing pattern's and characterics have been observed 
